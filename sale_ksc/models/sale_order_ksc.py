...
class SaleOrderKsc(models.Model):
    ...
    def compute_weight(self):
        '''
        it is for calculate the total weight
        :return: True
        '''
        total_weights = []
        self.total_weight = 0
    ...
    def compute_volume(self):
        '''
        it is for calculate the total volume
        '''
        for rec in self:
    ...
    def _compute_ordertotal(self):
        '''
        it is for calculate the order total
        :return: True
        '''
        for rec in self:
    ...
    def _compute_total_tax(self):
        '''
        this compute field is depended on order line ids and calculate total tax
        :return: True
        '''
        for order in self:
            order.total_tax = 0
    ...
    def _compute_untaxed_amount(self):
        '''
        this compute field is also depended on order lines ids and it is for calculate total untaxed amount
        :return: True
        '''
        for order in self:
    ...
    def _compute_total_amount(self):
        '''
        this field calculate total amount
        :return: True
        '''
        for order in self:
